...
$FileNamesToPack = @(
    ...
    "TradeJournalGateway.java",
    "TradeJournalGatewayImpl.java",
    "NoopTradeJournalGateway.java",
    "ExecutionJournalService.java",
    "TradeExecutionEvent.java",
    "TradeExecutionEventRepository.java",
    "TradeExecutionIngest.java",
    "TradeExecutionJournalService.java",
    "TradeIntentEvent.java",
    "TradeIntentEventRepository.java",
    "TradeIntentJournalService.java",
    "TradeOrderLink.java",
    "TradeOrderLinkRepository.java",
    "TradeOrderLinkService.java",
    "TradeOutcome.java",
    "TradeOutcomeRepository.java",
    "TradeOutcomeAssemblerService.java",
    "OrderCorrelation.java",
    "ExchangeClient.java",
    "BinanceExchangeClient.java",
    "BybitExchangeClient.java",
    "AccountBalanceService.java",
    "AccountBalanceSnapshot.java",
    "MarketSymbolService.java",
    "MarketSymbolServiceImpl.java",
    "SymbolDescriptor.java",
    "V20260309_03__orders_add_exchange_network.sql",
    "V20260310_01__orders_backfill_exchange_network.sql"
)
# =========================================================

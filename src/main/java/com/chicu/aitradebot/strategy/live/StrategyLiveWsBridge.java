...
public class StrategyLiveWsBridge {
    ...
    public void publish(StrategyLiveEvent ev) {
        ...
        if (ev.getChatId() == null || ev.getStrategyType() == null) {
            log.warn("LIVE SKIP missing chatId/strategy type={} chatId={} strategy={}",
        ...
        if (ev.getType() == null || ev.getType().isBlank()) {
            log.warn("LIVE SKIP missing type chatId={} strategy={} symbol={}",
        ...
        switch (ev.getType()) {
            ...
            case "candle" -> {
                if (ev.getTime() <= 0) {
                    log.debug("DROP candle without time chatId={} strategy={} symbol={}",
                            ev.getChatId(), ev.getStrategyType(), ev.getSymbol());
                    return;
                }
            }
        ...
        try {
            ...
            log.warn("UI persist failed type={} chatId={} strategy={} symbol={}",
    ...
    private void persistUiLayer(StrategyLiveEvent ev) {
        ...
        switch (ev.getType()) {
            ...
            case "zone" -> {
                ...
                uiLayers.saveZone(
                        ev.getChatId(), ev.getStrategyType(), ev.getSymbol(), time,

...
import com.chicu.aitradebot.ml.tuning.scalping.ScalpingBacktestSimulator;
    ...
    public BacktestMetrics backtest(Long chatId,
        ...
        try {
            ...
            if (type == StrategyType.SCALPING) {
                return ScalpingBacktestSimulator.run(chatId, settings, symbol, timeframe, startAt, endAt, candidateParams, candles);
            }
